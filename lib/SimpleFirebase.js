...
class SimpleFirebaseUI {
	...
	constructor (authObj, parentSelector = "Body") {
		...
		/*this.fbUiHandler.start(parentSelector, {
			signInOptions: [
				{
					provider: firebase.auth.GoogleAuthProvider.PROVIDER_ID,
					authMethod: 'https://accounts.google.com',
					clientId: "646527306803-1ecjnmee3pddu6tkakrevs7lkka1daql.apps.googleusercontent.com"
				}
			],

			callbacks: {
				signInSuccessWithAuthResult (res, redirectTo) {
					console.log(res);
